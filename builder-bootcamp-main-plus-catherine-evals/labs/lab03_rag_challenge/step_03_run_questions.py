...
Note: This file contains challenge TODOs labeled "Task 3.x". Implement each block
...
Usage (from repo root or anywhere):
    ...
    # or
    python labs/lab03_rag_challenge/step_03_run_questions.py
...
def ask_question(
    ...
    # <Task 3.1> Define a system message for Acme's support assistant
    # TODO: Author a concise prompt that:
    #   - Uses File Search context to ground answers; refuses when evidence is missing
    #   - Keeps responses concise, structured, and professional (bullets acceptable)
    #   - Avoids guessing or unsupported details
    # Replace this placeholder with your prompt text.
    system_message = None  # TODO

    # <Task 3.2> Call the Responses API with File Search
    # TODO: Create a responses call that:
    #   - Uses your chosen model and reasoning effort
    #   - Sends a system message (from Task 3.1) and the user’s question
    #   - Enables File Search, attaching the vector store you created in Task 2
    #   - Limits retrieval depth appropriately for your use case
    #   - Carries lightweight run metadata (e.g., a UUID)
    # Replace this placeholder with a working call.
    raise NotImplementedError("Task 3.2: implement responses.create with system/user messages and file_search tool")
